...
class ShopList extends React.Component {
    render(){
        const spinLoader = <div style={{textAlign: 'center', fontSize: 12, lineHeight: 1.5, paddingTop: 15, paddingBottom: 5, clear: 'both'}}><img src={load} style={{height:10,width:10}} alt=""/>正在加载...</div>
